        ...
        <aside className="sticky top-0 w-full md:w-3/12 flex gap-3 flex-col">
            <div className="p-4 bg-black rounded-lg hover:shadow-2xl duration-500">
                ...
                <div className="flex justify-between">
                    <div>
                        <span className="font-medium text-[15px]">Follow our Socials</span>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2 items-center w-full my-3">
                    <Link href={'#'} className="rounded-md hover:bg-blue-500 duration-500 py-1 px-2 flex gap-1 items-center justify-between text-[15px] bg-blue-600" >
                        ...
                        <span className="font-medium">109K</span>
                        <span>Fol</span>
                    </Link>
            ...
            <div className="p-4 bg-black rounded-lg hover:shadow-2xl duration-500">
                ...
                <div className="flex justify-between">
                    <div>
                        <h1 className="font-medium text-[15px]">Recent Posts</h1>
                    </div>
                    <button className="hover:bg-white/10 backdrop-blur-sm p-1 rounded-full duration-500">
                        <LuMoreHorizontal />
                    </button>
                ...
                <div className="grid grid-cols-1 gap-2 items-center w-full my-3">
                    <Link href={'#'} className="w-full flex gap-2 items-center justify-between text-[12px] group">
                        ...
                        <div className="w-9/12">
                            <h1 className="group-hover:text-gray-400 duration-500 font-medium leading-tight">Delight bought a new range rover velar and a sport puarsango ferrari</h1>
                        </div>
                    </Link>
                    <Link href={'#'} className="w-full flex gap-2 items-center justify-between text-[12px] group">
                        <Image src={imgOne} className="w-3/12" alt="" />
            ...
            {/* <div className="p-4 bg-black rounded-lg hover:shadow-2xl duration-500">
                <div className="flex justify-between">
                    <div className="flex gap-1 items-center">
                        <AiOutlineRise />
                        <span className="text-[15px] font-medium">Finance</span>
                    </div>
                    <button className="hover:bg-white/10 backdrop-blur-sm p-1 rounded-full duration-500">
                        <LuMoreHorizontal />
                    </button>
                ...
                <div className="flex flex-col gap-2 w-full my-3">
                    <div className="flex bg-gray-300/30 hover:bg-gray-300/40 duration-500 rounded-md backdrop-blur-md w-full p-1">
                        <div className="w-8/12">
                            <div className="flex flex-col">
                                <p className="font-medium text-[12px]">USD/NGN</p>
                        ...
                        <div className="w-4/12 flex justify-center">
                            <div className="flex w-full justify-between items-center">
                                ...
                                <div className="flex flex-col">
                                    <p className="font-medium text-red-500 text-[9px]">-0.34%</p>
                                    <p className="font-medium text-[9px]">500.60</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex bg-gray-300/30 hover:bg-gray-300/40 duration-500 rounded-md backdrop-blur-md w-full p-1">
                        <div className="w-8/12">
                            <div className="flex flex-col">
                                <p className="font-medium text-[12px]">GBP/USD</p>
                        ...
                        <div className="w-4/12 flex justify-center">
                            <div className="flex w-full justify-between items-center">
                                ...
                                <div className="flex flex-col">
                                    <p className="font-medium text-green-500 text-[9px]">+0.25%</p>
                                    <p className="font-medium text-[9px]">1420.13</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="p-4 bg-black rounded-lg hover:shadow-2xl duration-500">
                <div className="flex justify-between">
                    <div className="flex gap-1 items-center">
                        <GoMegaphone />
                        <span className="text-[15px] font-medium">Ads</span>
                    </div>
                    <button className="hover:bg-white/10 backdrop-blur-sm p-1 rounded-full duration-500">
                        <LuMoreHorizontal />
                    </button>
                        ...
                        <div className="relative rounded-md h-full bg-black/10">
                            ...
                            <div className="absolute z-20 bottom-1 left-1 w-11/12 rounded-md group">
                                ...
                                <div className="flex justify-between mt-0.5">
                                    <span className="text-[12px] font-medium p-0.5 px-1 rounded-full">
                                        $25.00
                                    </span>
