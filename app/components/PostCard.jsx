            ...
            <div className="w-full">       
                <div>
                    <div className="text-[13px] flex gap-1 items-center">
                        <Link href={'/'} className="text-black/80 rounded-md font-normal flex gap-1 items-center">Home
                        </Link>/
                        <Link href={`/blogs/categories/${data.categoryId}`} className="rounded-md font-normal flex gap-1 items-center hover:text-black/80 duration-500">
                    ...
                    <h1 className="w-full my-4 font-normal text-2xl md:text-4xl">{data.title}</h1>
                ...
                <div className="mt-12">
                    <div className="mb-4 heading">
                        <span className="font-normal text-base mb-0.5">Related Posts</span>
                            ...
                            <article className="h-72" key={r.id}>
                                <Link href={`/blogs/${r.id}`} className="group rounded-lg h-72 hover:shadow-2xl shadow-black duration-500 relative">
                                    ...
                                    <div className="bg-black p-3 t-box h-3/6 relative">
                                        ...
                                        <div className="my-2">
                                            <h2 className="text-[15px] font-normal duration-500">{r.title}</h2>
                                        </div>
