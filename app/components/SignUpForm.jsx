        ...
        <div className="flex justify-center items-center h-screen w-full bg-white backdrop-blur-sm fixed top-0 left-0">
            <div className="rounded-lg w-[95%] md:w-4/12 shadow-2xl shadow-black px-6 py-6 text-black z-40 bg-white relative">
                <div className="w-full pb-6">
                    <h1 className="font-medium text-xl md:text-2xl pb-0.5">Trends Talkhubb - Sign up</h1>
                </div>
                <div className="w-full text-[12px]">
                    ...
                    <form className="w-full" onSubmit={handleSubmit}>
                        ...
                        <div className="">
                            <span className="text-gray-500">Already have an account? </span><Link href={'/login'} className="text-black font-medium">Log in</Link>
                        </div>
                    </form>
                </div>
            </div>
