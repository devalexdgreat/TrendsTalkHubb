...
const links = [
  ...
  const stats = [
    ...
    { name: 'Active hours per day', value: '22+' },
    { name: 'Trends', value: 'Unlimited' },
  ]
  ...
  export default function About() {
    return (
      <div className="relative isolate overflow-hidden bg-black py-24 sm:py-32">
        <Navbar/>
        {/* <Image
          src="/bg.avif" width={1000} height={1000}
          alt=""
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
                Welcome to Trendstalk Hubb, your go-to platform for exploring the latest trends and insights across various industries.
